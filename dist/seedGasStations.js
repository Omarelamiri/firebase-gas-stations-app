            ...
            switch (_a.label) {
                case 0:
                    stations = [
                        {
                            name: "Station Alpha",
                            location: new firestore_1.GeoPoint(34.020882, -6.841650),
                            address: "123 Main St",
                            city: "Rabat",
                            brand: "Shell",
                        ...
                        {
                            name: "Station Beta",
                            location: new firestore_1.GeoPoint(33.573110, -7.589843),
                            address: "456 Elm St",
                            city: "Casablanca",
                            brand: "Total",
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, firestore_1.addDoc)((0, firestore_1.collection)(db, "gasStations"), __assign(__assign({}, station), { updatedAt: (0, firestore_1.serverTimestamp)() }))];
                case 2:
                    _a.sent();
                    console.log("Added: ".concat(station.name));
                    _a.label = 3;
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
